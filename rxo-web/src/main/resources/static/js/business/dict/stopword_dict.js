(function (document, window, $) {
    ...
    (function () {
        var $keywordTable = $('#stopword-table');
        var _keyword_table = $keywordTable.bootstrapTable({
            method: 'POST',
            url: "/business/stopword/stopwordDict/list",
            dataField: "records",
        ...
        $('#keyword_btn_delete').click(function () {
            ...
            swal({
                ...
                $.ajax({
                    type: "DELETE",
                    url: "/business/stopword/stopwordDict/" + selectItemIds,
        ...
        $('#update_keyword_save').click(function () {
            ...
            $.ajax({
                type: "PUT",
                url: "/business/stopword/stopwordDict/" + updateKeyword.id,
                async: false,
                cache: false,	//禁用缓存
        ...
        $('#create_keyword_save').click(function () {
            ...
            $.ajax({
                type: "POST",
                url: "/business/stopword/stopwordDict",
                async: false,
                cache: false,	//禁用缓存
