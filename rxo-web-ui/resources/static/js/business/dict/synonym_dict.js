(function (document, window, $) {
    ...
    (function () {
        var $keywordTable = $('#synonym-table');
        var _keyword_table = $keywordTable.bootstrapTable({
            method: 'POST',
            url: "/business/synonym/synonymDict/list",
            dataField: "records",
        ...
        $('#keyword_btn_delete').click(function () {
            ...
            swal({
                ...
                $.ajax({
                    type: "DELETE",
                    url: "/business/synonym/synonymDict/" + selectItemIds,
        ...
        $('#update_keyword_save').click(function () {
            ...
            $.ajax({
                type: "PUT",
                url: "/business/synonym/synonymDict/" + updateKeyword.id,
                async: false,
                cache: false,	//禁用缓存
        ...
        $('#create_keyword_save').click(function () {
            ...
            $.ajax({
                type: "POST",
                url: "/business/synonym/synonymDict",
                async: false,
                cache: false,	//禁用缓存
